...
if  (idade >=18){
    ...
    console.log ("Você está quase no ponto para dirigir," + "aguente mais um pouco");
}
else  {
 ...
 * > = maior ou igual a  =>                         11 => 11 falso
 * < = igual a menor ou igual a =>                  10 <=11 verdade
 * 
 * Exemplos com texto
 * 'Ana' . 'ana' => Falso
 * 
 * Operadores lógicos
 * && operadores AND => idade >=18 && idade <= 60
 ...
 * ! operadores NOT  => !( idade >=18 && idade <=60)
